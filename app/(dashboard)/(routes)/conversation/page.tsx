      ...
      <div className="px-4 lg:px-8">
        <Form {...form}>
          <form
            ...
            className="rounded-lg border w-full p-4 px-3 md:px-6 focus-within:shadow-sm grid grid-cols-12 gap-2 bg-white dark:bg-[#080c14] border-gray-200 dark:border-[#080c14]"
          >
            <FormField
              name="prompt"
              render={({ field }) => (
